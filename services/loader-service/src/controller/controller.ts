import { clearRankingsTable, clearResultsTable, clearTeamsTable, clearUpcomingGamesTable } from '../data/clear';
...
export async function main(){
  ...
  console.log(`Successfully fetched ${upcomingGamesRaw.length} upcoming games and ${resultsRaw.length} game results.`);
  console.log(`=================================================`);
  ...
  console.log(`Extracted ${upcomingGamesData.length} relevant upcoming games.`);
  ...
  console.log(`Successfully persisted ${upcomingGamesData.length} upcoming games.`);
  console.log(`=================================================`);
